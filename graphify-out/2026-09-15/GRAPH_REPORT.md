...
- `api()` --calls--> `handleAdminRequest()`  [EXTRACTED]
  tests/unit/admin-services.test.ts → src/features/admin/server/api.ts
- `newInvoice()` --calls--> `saveDocument()`  [EXTRACTED]
  tests/unit/admin-services.test.ts → src/features/admin/server/documents.ts
- `sentInvoice()` --calls--> `changeDocumentStatus()`  [EXTRACTED]
  tests/unit/admin-services.test.ts → src/features/admin/server/documents.ts
...
Cohesion: 0.36
Nodes (6): AdminError, getReplies(), listMessages(), messageRecord(), timestamp(), sendAdminReply()
...
Cohesion: 0.18
Nodes (12): loginSchema, passwordSchema, digest(), login(), loginQuota(), SESSION_COOKIE, SESSION_SECONDS, sessionActor() (+4 more)
...
### Community 64 - "api.ts"
Cohesion: 0.19
Nodes (28): dynamic, handler(), runtime, cookieOptions, handleAdminRequest(), json(), revision, assertAdmin() (+20 more)
...
### Community 104 - "basic-forms.tsx"
Cohesion: 0.24
Nodes (16): decimalFromMinor(), currencies, ClientRecord, ClientForm(), LoginForm(), SettingsForm(), ErrorNotice(), DocumentForm() (+8 more)
...
Cohesion: 0.10
Nodes (27): ClientInput, clientSchema, date, decimal, DocumentKind, email, estimateStatuses, idSchema (+19 more)
...
Cohesion: 0.06
Nodes (22): generateMetadata(), arabicFont, RootDocument(), siteFont, ContactDialogContext, ContactDialogContextValue, ContactDialogProvider(), Footer() (+14 more)
...
Cohesion: 0.16
Nodes (21): calculateDocument(), checked(), MAX_MINOR, scaled(), DocumentInput, documentSchema, getClient(), convertEstimate() (+13 more)
...
Cohesion: 0.19
Nodes (15): formatMoney(), MessageDetailPage(), SettingsPage(), OverviewPage(), DateValue(), Details(), EmptyState(), Filters() (+7 more)

### Community 136 - "admin-services.test.ts"
Cohesion: 0.24
Nodes (9): actor, api(), client, contact, input(), newInvoice(), req(), sentInvoice() (+1 more)

### Community 137 - "Q: Make Journal videos play like portfolio videos and place the first video at the beginning while keeping remaining videos in place"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Make Journal videos play like portfolio videos and place the first video at the beginning while keeping remaining videos in place, Source Nodes
...
## Knowledge Gaps
- **821 isolated node(s):** `lintStagedConfig`, `init-test-db.sh script`, `withNextIntl`, `nextConfig`, `name` (+816 more)
