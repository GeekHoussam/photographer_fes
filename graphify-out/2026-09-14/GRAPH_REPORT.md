...
## Corpus Check
- 241 files · ~3,855,314 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1625 nodes · 2963 edges · 152 communities (114 shown, 38 thin omitted)
...
Cohesion: 0.19
Nodes (14): ServicesPage(), ServicePage(), ButtonLink(), styles, Container(), ContainerProps, ResponsiveMedia(), ContactMethods() (+6 more)

### Community 1 - "structured-data.ts"
Cohesion: 0.16
Nodes (34): JournalArticlePage(), ProjectPage(), absoluteUrl(), localizedUrl(), withTrailingSlash(), aboutPageJsonLd(), breadcrumbFor(), breadcrumbJsonLd() (+26 more)
...
Cohesion: 0.13
Nodes (20): JournalVideo(), VideoCard(), VideoCardLabels, arabicTitleByVideoId, definitionBySlug, filterPortfolioVideos(), getVideoEmbedUrl(), getVideoThumbnailUrl() (+12 more)
...
Cohesion: 0.07
Nodes (28): json(), POST(), runtime, Button(), ContactDialogContext, ContactDialogContextValue, ContactDialogProvider(), ContactForm() (+20 more)
...
Cohesion: 0.15
Nodes (15): JournalArticleContent(), RichText(), importedJournalArticles, mediaBySlug, JournalArticle, JournalBodyBlock, JournalLocaleContent, JournalRichText (+7 more)
...
### Community 64 - "api.ts"
Cohesion: 0.06
Nodes (91): main(), [command, emailArg, nameArg], email, main(), readPassword(), dynamic, handler(), runtime (+83 more)
...
Cohesion: 0.11
Nodes (29): ClientInput, clientSchema, currencies, date, decimal, email, estimateStatuses, invoiceStatuses (+21 more)

### Community 107 - "lens-hero.test.tsx"
Cohesion: 0.12
Nodes (13): SmoothScroll(), createLensInput(), createLensMotion(), idleInput, LensInput, LensParts, updateLensFrame(), LensAssembly() (+5 more)
...
Cohesion: 0.10
Nodes (21): alternates(), dynamic, sitemap(), PageContent, PageCopy, ProcessStep, staticPageContent, StaticPageKey (+13 more)

### Community 110 - "types.ts"
Cohesion: 0.15
Nodes (17): calculateDocument(), checked(), decimalFromMinor(), formatMoney(), MAX_MINOR, scaled(), DocumentInput, DocumentKind (+9 more)
...
Cohesion: 0.07
Nodes (23): metadata, generateMetadata(), dynamic, robots(), arabicFont, RootDocument(), siteFont, Footer() (+15 more)
...
Cohesion: 0.11
Nodes (21): EditEstimatePage(), EditInvoicePage(), EstimateDetailPage(), EstimatesPage(), InvoiceDetailPage(), InvoicesPage(), NewEstimatePage(), NewInvoicePage() (+13 more)

### Community 118 - "adminI18n"
Cohesion: 0.20
Nodes (11): AdminLayout(), dynamic, generateMetadata(), runtime, AdminLoading(), LoginPage(), AdminNotFound(), currentActor (+3 more)

### Community 119 - "Locale"
Cohesion: 0.19
...
Cohesion: 0.26
Nodes (7): PortfolioFilters(), projectCardClasses, categoryLabel(), categoryOrder, isPortfolioCategory(), labels, isVideoCategory()

### Community 121 - "clients-pages.tsx"
Cohesion: 0.17
Nodes (15): requireAdmin(), ClientDetailPage(), ClientsPage(), EditClientPage(), NewClientPage(), DocumentDetail(), DocumentEditor(), DocumentsPage() (+7 more)
...
### Community 147 - "project-card.tsx"
Cohesion: 0.38
Nodes (6): aspectClasses, ProjectCard(), ProjectPreview(), handlePointerMove(), paintPointerPosition(), resetPreview()

## Knowledge Gaps
- **807 isolated node(s):** `lintStagedConfig`, `init-test-db.sh script`, `withNextIntl`, `nextConfig`, `name` (+802 more)
...
- **Why does `Locale` connect `Locale` to `journal/[slug]/page.tsx`, `api.ts`, `structured-data.ts`, `videos.ts`, `route.ts`, `isLocale`, `header.tsx`, `arabic-locale.test.ts`, `site.ts`, `content.ts`, `project-card.tsx`, `projects.ts`, `portfolio-filters.tsx`, `mappers.ts`, `controls.tsx`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `isLocale()` connect `isLocale` to `journal/[slug]/page.tsx`, `structured-data.ts`, `site.ts`, `adminI18n`, `mappers.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `adminI18n` connect `adminI18n` to `clients-pages.tsx`, `isLocale`, `document-pages.tsx`?**
